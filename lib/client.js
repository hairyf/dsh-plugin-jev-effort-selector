	...
	factory: (require) => {
		...
		function EffortChip(props) {
			...
			if (!sessionOn) {
				...
				const muted = NOT_DECIDED.indexOf(decision.reason) !== -1;
				body = [
					React.createElement("span", { key: "n", style: muted ? mutedStyle : nameStyle }, "Jev"),
					React.createElement("span", { key: "l", style: muted ? mutedStyle : levelStyle(effort) }, effort === "" ? "—" : label(effort)),
				];
