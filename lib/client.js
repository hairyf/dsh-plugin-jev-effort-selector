...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		 ...
		 * is the effort the latest request actually carried — Jev's pick while
		 * the plugin is on, and the manual selection when it is off. It
		 * deliberately does NOT claim Jev chose it, and no longer shows a
		 * confidence: the fold reads the request, not the decision behind it.
		 *
