...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		/**
		 * Turn a refused settings write into a thrown error. The older transport
		 * resolves `undefined` and rejects on failure; the newer one resolves
		 * `false` when the Host refuses. Both then end up in the same catch.
