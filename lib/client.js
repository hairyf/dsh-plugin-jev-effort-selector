	...
	factory: (require) => {
		...
		class JevForm {
			constructor(scope, credentials) {
				 ...
				 * a successful write.
				 */
				this.secret = { ref: "", info: undefined, draft: "", busy: false, error: "" };
			...
			syncSecret() {
				...
				this.secret = { ...this.secret, ref, info: undefined, error: "" };
				this.publish();
		...
		function SecretField(props) {
			...
			const locked = disabled || secret.busy || secret.ref === "" || shadowed;
